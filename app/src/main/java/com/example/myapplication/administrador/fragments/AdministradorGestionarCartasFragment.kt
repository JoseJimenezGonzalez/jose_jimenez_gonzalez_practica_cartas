...
import com.example.myapplication.administrador.model.adapter.viewpager.ViewPagerAdapterCards
...
class AdministradorGestionarCartasFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val adapter = ViewPagerAdapterCards(childFragmentManager, lifecycle)
